    ...
    def get_anmeldekontakt(self, anmeldung):
        ...
        anmeldekontakt = h.FieldsetInputTable(
            ...
            daten=[[h.TextItem(label='Gemeldet von',
                               name='von',
                               tip="Name des Anmeldenden (z.B. Eltern, Klient selbst, SozialarbeiterIn)",
                               value=anm['von'],
                               ),
                    h.TextItem(label='Telefon',
                               name='mtl',
                               tip="Telefonnummer des Anmeldenden",
                               value=anm['mtl'],
                               ),
                    ],
                   [h.SelectItem(label='Empfohlen von',
                                 name='zm',
                                 tip="Einrichtung bzw. Art der Empfehlung",
                                 options=self.for_kat('fszm', anm['zm']),
                                 ),
                    h.TextItem(label='durch',
                               name='me',
                               tip="Name der empfehlenden Person (z.B. aus der Einrichtung)",
                               value=anm['me'],
                               ),
                    ],
                   ...
                   [h.TextItem(label='Anmeldegrund',
                               name='mg',
                               value=anm['mg'],
                               tip="Gründe, die der Anmeldende angibt",
