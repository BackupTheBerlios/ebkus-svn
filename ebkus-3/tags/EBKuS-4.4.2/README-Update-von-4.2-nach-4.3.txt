Update von EBKuS 4.2 nach 4.3
=============================


Update einer vorhandenen Version 4.2 nach 4.3:

0. Stellen Sie sicher, dass die Version 4.2 installiert
...
4. Anpassung der Konfigurationsdatei (für den Update von 4.2 auf
   4.3 nicht nötig)
...
Da das Datenbankschema in EBKuS 4.3 sich gegenüber 4.2 verändert
